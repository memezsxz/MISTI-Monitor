...
export function ChatHistoryDialog({
    ...
    return (
        <div className="fixed inset-0 z-50 ">
            ...
            <div className="absolute left-1/2 top-1/2 w-[min(900px,92vw)] -translate-x-1/2 -translate-y-1/2 rounded-2xl border border-white/10 bg-zinc-950 shadow-xl">
                ...
                <div className="max-h-[11rem] overflow-y-auto p-3">
                    ...
                    <div className="grid gap-2">
                        {rows.map((r) => (
                            <button
                                ...
                                className={clsx(
                                    "w-full text-left rounded-xl border border-white/10 bg-white/5 hover:bg-white/10 transition",
                                    "px-4 py-3"
                                )}
                            >
